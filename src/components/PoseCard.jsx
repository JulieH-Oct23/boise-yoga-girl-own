import { Box, Heading, Image, Text, IconButton, useColorModeValue } from "@chakra-ui/react";
import { CloseIcon } from "@chakra-ui/icons";
import { Link } from "react-router-dom";
import images from "../images";

const PoseCard = ({ _id, name, image, size = "default", disableLink = false, onRemove }) => {
  ...
  return disableLink ? content : <Link to={`/pose/${_id}`} style={{ textDecoration: "none" }}>{content}</Link>;
};
